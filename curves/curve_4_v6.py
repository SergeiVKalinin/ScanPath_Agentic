...
# description: Minimizing both amplitudes with proven frequency ratio 1.25 for maximum uniformity
import numpy as np
N = 1000
# --- parameters ---
num_lines = 350
x_amp = 0.0055  # Minimal horizontal perturbation
y_amp = 0.0045  # Minimal vertical perturbation
x_freq = 20     # Moderate horizontal oscillation
y_freq = 25     # Ratio 1.25, proven effective range
# --- curve generation ---
t = np.linspace(0, 1, N)
x = np.zeros(N)
y = np.zeros(N)
