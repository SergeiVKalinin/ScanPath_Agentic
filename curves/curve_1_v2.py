# curve_type: serpentine_with_six_frequency_prime_system
# description: Six-frequency prime system with third frequency pair (43, 47), amplitudes 0.002-0.004
import numpy as np
N = 1000
# --- parameters ---
num_lines = 300
...
x_tertiary_amp = 0.003
y_tertiary_amp = 0.002
coupled_amp = 0.004
x_primary_freq = 17
y_primary_freq = 23
x_secondary_freq = 29
