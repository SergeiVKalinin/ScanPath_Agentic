...
# description: Exploring frequency gap with ratio 1.41, filling range between best performers
import numpy as np
N = 1000
# --- parameters ---
num_lines = 350
x_amp = 0.007  # Proven amplitude range
y_amp = 0.005  # Conservative vertical perturbation
x_freq = 17    # Moderate-low horizontal oscillation
y_freq = 24    # Ratio 1.41 to explore frequency gap
# --- curve generation ---
t = np.linspace(0, 1, N)
x = np.zeros(N)
y = np.zeros(N)
